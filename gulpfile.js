...
var optimizeHtmlTask = function(src, dest) {
  ...
  return gulp.src(src)
    ...
    .pipe($.useref())
    // .pipe($.if('*.html',
    // $.replace('elements/elements.html', 'elements/elements.vulcanized.html')))
    // Minify any HTML
...
gulp.task('copy', function() {
  ...
  var bower = gulp.src([
    'app/bower_components/{webcomponentsjs,platinum-sw,sw-toolbox,promise-polyfill,page}/**/*'
  ]).pipe(gulp.dest(dist('bower_components')));

  return merge(app, bower, json, script)
    .pipe($.size({
      title: 'copy'
    }));
});
